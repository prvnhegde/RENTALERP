...
SELECT pg_catalog.setval('seq_blog_post_id', 1, false);
...
INSERT INTO system_config (config_key, config_value) VALUES ('auth.domain', NULL);
INSERT INTO system_config (config_key, config_value) VALUES ('auth.ldapUrl', NULL);
...
INSERT INTO system_config (config_key, config_value) VALUES ('email.allowedDomains', NULL);
...
INSERT INTO system_config (config_key, config_value) VALUES ('url.application', 'http://localhost:8080');
...
insert into system_config (config_key, config_value) values ('Issues.DueDateDiff', null);

-- New Admin user logout page
insert into access_page (page_id, page_name, module_id) values (327, '/admin/user-logout', 10);
insert into access_perm_page_map(perm_id, page_id) values (4, 327);

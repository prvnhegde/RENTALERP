...
<form action="${formAction}" method="post" id="softwareBookmarkEditForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
<table class="listTable">
    ...
    <tr>
        ...
        <td><html:text name="form" property="bookmarkName" size="40"/>&nbsp;<k:message key="common.requiredFieldIndicator.true"/></td>
    </tr>
    <tr>

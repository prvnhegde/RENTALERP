...
<form action="${formAction}" method="post" id="userEditForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
<html:hidden name="form" property="userId"/>
<table class="standardForm">
    <tr>
        <th><k:message key="common.column.user_id"/>:</th>
        <td><k:write value="${userId}"/></td>
    ...
    <tr>
        ...
        <td><html:select name="form" property="messenger1Type">
            <html:options collection="messengerType1Options" property="value" labelProperty="label"/>
            </html:select>
        ...
        <td>
            ...
            <html:options collection="messengerType2Options" property="value" labelProperty="label"/>
            </html:select>

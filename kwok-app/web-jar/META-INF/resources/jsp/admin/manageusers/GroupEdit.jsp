...
<form action="${formAction}" method="post" id="groupEditForm" onsubmit="Js.Form.selectAllOptions(this.selectedMembers); return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
<html:hidden name="form" property="groupId"/>
<table class="standardForm">
    <tr>
        <th><k:message key="common.column.group_id"/>:</th>
        <td><k:write value="${form.groupId}"/></td>
    </tr>
    <tr>
        <th><k:message key="common.requiredFieldIndicator.true"/><k:message key="common.column.group_name"/>:</th>

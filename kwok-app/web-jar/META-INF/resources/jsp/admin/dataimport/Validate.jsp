...
<form action="${formAction}" method="post" enctype="multipart/form-data" onsubmit="return App.disableButtonSubmit(this.submitBtn)">
<input type="hidden" name="_resubmit" value="true">
<table class="listTable">
<tr class="themeHeader">
    <th class="rownum">#</th>
    <th><k:message key="${nameHeader}"/></th>
    <th><k:message key="import.heading.action"/></th>
...
<k:foreach id="row" name="dataList">
    ...
    <tr>
        ...
        <td><k:message key="import.validate.action.${importItem.action}"/></td>
        <td>
...
<p>
<button type="submit" name="submitBtn"><k:message key="form.button.import"/></button>
&nbsp;
<input type="button" onclick="Js.Response.redirect('${formBackAction}')" value="<k:message key="form.button.back"/>">
${formCancelLink}
</form>
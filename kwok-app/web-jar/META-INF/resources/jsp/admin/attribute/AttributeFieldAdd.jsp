...
<h2><k:message key="admin.attributeAdd.header"/>:
...
<form action="${formAction}" method="post" id="attributeFieldAddForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">

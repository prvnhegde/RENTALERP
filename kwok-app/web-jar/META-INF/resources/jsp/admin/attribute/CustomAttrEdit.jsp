...
<form action="${formAction}" method="post" id="customAttributeEditForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
...
<table class="${StandardTemplate.detailsTableStyle}">
    <tr>
        ...
        <td><input type="text" name="attrName" value="<k:write value="${form.attrName}"/>" size="48" maxlength="50" autofocus></td>    </tr>
    <tr>

...
<form action="${formAction}" method="post" id="articleEditForm" onsubmit="return App.disableButtonSubmit(this.submitBtn)">
            ...
            <k:notEqual name="isWikiSyntax" value="true">
                <script type="text/javascript">
                    CKEDITOR.replace( 'articleText' , {
                        language: '${language}',
                        filebrowserLinkBrowseUrl: '${fileBrowseUrl}',
                        filebrowserImageBrowseUrl: '${fileBrowseUrl}',
                        filebrowserFlashBrowseUrl: '${fileBrowseUrl}',

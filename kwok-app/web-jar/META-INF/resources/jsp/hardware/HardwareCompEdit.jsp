...
<form action="${formAction}" method="post" id="hardwareCompEditForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
<html:hidden name="form" property="hardwareId"/>
<html:hidden name="form" property="compId"/>
<div class="tabBody">
    <div class="themeHeader">
        <b><k:message key="itMgmt.cmd.hardwareComponentEdit"/></b>
    </div>
        <table class="standardForm">    
            <tr>
                <th nowrap><k:message key="common.requiredFieldIndicator.true"/><k:message key="common.column.hardware_component_type"/>:</th>

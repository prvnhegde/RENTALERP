...
<form action="${formSearchAction}" id="hardwareMemberForm" method="post" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
            ...
            <k:isPresent name="hardwareList">
                <table class="noBorder">
                    <k:foreach id="hardware" name="hardwareList">
                        <tr><td><html:checkbox name="form" property="formHardwareId" value="${hardware.hardwareId}"/>

...
<tr>
        <th><k:message key="common.column.hardware.return.date"/>:</th>
        <td>
            <html:select name="HardwareSearchForm" property="returnDate" value="${returnDate}">
                <html:options collection="returnDateOptions" property="value" labelProperty="label"/>
            </html:select>
        	<html:select name="HardwareSearchForm" property="returnMonth" value="${returnMonth}">
                <html:options collection="returnMonthOptions" property="value" labelProperty="label"/>
            </html:select>
            <html:select name="HardwareSearchForm" property="returnYear" value="${returnYear}">
                <html:options collection="returnYearOptions" property="value" labelProperty="label"/>
            </html:select>
        </td>
</tr>      
<tr>
        <td colspan="4" style="text-align:left">
            <button type="submit" name="submitBtn"><k:message key="itMgmt.cmd.return"/></button>
            ${formCancelLink}
        </td>
    </tr>
</table>

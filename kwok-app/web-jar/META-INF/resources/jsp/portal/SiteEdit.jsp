...
<form action="${formAction}" method="post" id="siteEditForm" onsubmit="return App.submitFormUpdate(this, {'disable' : this.submitBtn})">
<input type="hidden" name="siteId" value="${form.siteId}">
<table class="${StandardTemplate.detailsTableStyle}">
    <tr>
        <th><k:message key="common.column.site_id"/>:</th>
        <td><k:write value="${siteId}"/></td>
    </tr>
    <tr>
        <th><k:message key="common.requiredFieldIndicator.true"/><k:message key="common.column.site_name"/>:</th>
        <td><input type="text" name="siteName" value="<k:write value="${form.siteName}"/>" size="40" autofocus></td>
    </tr>
    <tr>
        <th><k:message key="common.requiredFieldIndicator.true"/><k:message key="common.column.site_path"/>:</th>
    ...
    <tr>
        <th><k:message key="common.column.site_support_iframe"/>:</th>

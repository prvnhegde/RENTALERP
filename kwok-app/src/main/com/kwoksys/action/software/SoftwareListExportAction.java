...
/**
 * Action class for exporting software list.
 */
public class SoftwareListExportAction extends Action2 {

    public String execute() throws Exception {
        SoftwareReport report = new SoftwareReport(requestContext, SessionManager.SOFTWARE_SEARCH_CRITERIA_MAP);

        ResponseContext responseContext = new ResponseContext(response);
        responseContext.setAttachementName(Localizer.getText(requestContext, "itMgmt.softwareListExport.filename"));

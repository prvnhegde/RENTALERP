...
public class ContactEdit2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return ajaxUpdateView(AppPaths.CONTACTS_CONTACT_EDIT + "?contactId=" + contact.getId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
        } else {
            return ajaxUpdateView(AppPaths.CONTACTS_CONTACT_DETAIL + "?contactId=" + contact.getId());
        }
    }
}

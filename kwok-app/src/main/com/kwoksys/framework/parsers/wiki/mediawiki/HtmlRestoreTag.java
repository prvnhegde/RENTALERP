...
/**
 * HtmlRestoreTag. Restore HTML tags that are allowed.
 */
public class HtmlRestoreTag extends Tag {

    public HtmlRestoreTag(String regex) {
        super(regex);
    }
    ...
    public StringBuffer parseContent(StringBuffer content, Parser parser) {
        ...
        while (m.find()) {
            String replace = Parser.decodeHtml(m.group(0));

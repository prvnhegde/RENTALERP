 ...
 * CompanyIssueLink
 */
public class CompanyIssueLink extends BaseObject {

    private Integer companyId;
    private Integer issueId;

    public CompanyIssueLink() {}

    public CompanyIssueLink(Integer companyId) {
        this.companyId = companyId;
    }

    public ObjectLink createObjectMap() {
        ObjectLink objectMap = new ObjectLink();
        objectMap.setObjectId(companyId);
        objectMap.setObjectTypeId(ObjectTypes.COMPANY);
